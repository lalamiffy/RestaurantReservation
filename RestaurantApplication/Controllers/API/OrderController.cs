...
namespace RestaurantApplication.Controllers.API
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<IActionResult> OrderItem(OrderItemModel model)
        {
            ...
            foreach (var menuItemId in menuItemIds)
            {
                ...
                if (menuItem != null)
                {
                    ...
                    //var updateOp = Builders<Order>.Update
                    //    .AddToSet((c) => c.Items, newitem);
                    //_ordercollection.UpdateOne((c) => c.Id == order.Id, updateOp);
        ...
        // [Route]
        // public async ActionResult<OrderItemModel>
        // {
        //  MenuItemIds =>
        // OrderId =>
